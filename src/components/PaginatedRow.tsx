          ...
          <>
            ...
            {canGoPrev && (
              <button
                ...
                className={`absolute -left-12 z-20 w-10 h-10 bg-[#00E5FF] hover:bg-[#00E5FF]/90 rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-[#00E5FF] focus:ring-offset-2 focus:ring-offset-[#0A0A0A] ${
            ...
            {canGoNext && (
              <button
                ...
                disabled={isLoading}
                className={`absolute -right-12 z-20 w-10 h-10 bg-[#00E5FF] hover:bg-[#00E5FF]/90 rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-[#00E5FF] focus:ring-offset-2 focus:ring-offset-[#0A0A0A] disabled:opacity-50 disabled:cursor-not-allowed ${
                  isHovered ? 'opacity-100' : 'opacity-0'
                }`}
                style={{
                  top: 'calc(50% - 20px)',
