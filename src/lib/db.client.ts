...
// ---- 常量 ----
// 新的键名（GouGouTV）
const PLAY_RECORDS_KEY = 'gougoutv_play_records';
const FAVORITES_KEY = 'gougoutv_favorites';
const SEARCH_HISTORY_KEY = 'gougoutv_search_history';
const SKIP_CONFIGS_KEY = 'gougoutv_skip_configs';
...
// 缓存相关常量
const CACHE_PREFIX = 'gougoutv_cache_';
